...
const Footer = () => {
    return (
        <div className='footer items-center p-4 bg-neutral text-neutral-content'>
            <footer className="footer items-center p-4 bg-neutral text-neutral-content flex-grow">
  <aside className="items-center grid-flow-col">
    
    <p>©2023-All right reserved by <Link to={"https://jmkutub1.web.app/"}>Kutub Uddin</Link> </p>
  </aside> 
