...
const Home = () => {
  ...
  return (
    <div className=' block m-auto items-center justify-center'>
      ...
      {viewAllUser
        ? users.map((user) => (
          <div key={user.id} className='flex  cols-span-12 justify-center '>
  <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl md:mx-4 mb-8 sm:px-12 dark:bg-gray-900 dark:text-gray-100">
    ...
    <button className=' hover:bg-red-600 m-auto p-4 bg-green-500 text-white' onClick={() => setViewAllUser(!viewAllUser)}>
